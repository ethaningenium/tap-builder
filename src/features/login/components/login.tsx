  ...
  return (
      <>
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          ...
          <div>
            <label htmlFor="email" className="block text-sm font-extralight leading-6 text-gray-400">
              Email address
            </label>
            <div className="mt-2">
            <input
              ...
              {errors.email && !isFocused && <p className="mt-1 text-sm text-red-500">{errors.email}</p>}
            </div>

            <div>
            <div>
            <label htmlFor="password" className="block text-sm font-extralight leading-6 text-gray-400">
              Password
            </label>
            <div className="mt-2">
            <input
